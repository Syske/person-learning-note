...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515111044.png)

点击`install CE`直接无法访问，不知道是被墙了，还是我网络的问题（难道移动宽带不让访问）

![](https://gitee.com/sysker/picBed/raw/master/images/image-20210515111152928.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515111921.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515112306.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515114430.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515114811.png)

密码长度必须大于等于`8`，然后点击`create user`

在实际测试的时候，我发现创建用户的时候会报错，我以为是，没有创建卷文件：

![](https://gitee.com/sysker/picBed/raw/master/images/20210515115142.png)

直到看到`docker`控制台的错误提示才明白，并不是：

![](https://gitee.com/sysker/picBed/raw/master/images/20210515115254.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515115633.png)

默认选中的是`k8s`，我们这里是`docker`，所以选择第一个：

![](https://gitee.com/sysker/picBed/raw/master/images/20210515115903.png)

但是我在进行下一步的时候，没有创建`volume`的报应来了（这一次应该是这个问题了）：

![](https://gitee.com/sysker/picBed/raw/master/images/20210515120249.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515121430.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515132048.png)

### Containers

容器管理，这个菜单是我们最常用的菜单之一，可以对我们已经创建的容器进行管理，包括启动、停止、删除、查看配置信息（端口、容器、创建时间）、查看日志等。

![](https://gitee.com/sysker/picBed/raw/master/images/20210515132412.png)

#### 新增容器

这里需要说下新增容器，新增容器点开之后是这样的：

![](https://gitee.com/sysker/picBed/raw/master/images/20210515140204.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515140558.png)

###### 其他属性设置

说实话，好到高级配置，我也没搞清楚

![](https://gitee.com/sysker/picBed/raw/master/images/20210515140928.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515133051.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515133204.png)

#### 资源信息

展示容器的内存、`cpu`、网络等信息，这里可以指定刷新时间，默认是`5s`

![](https://gitee.com/sysker/picBed/raw/master/images/20210515133716.png)

#### 控制台

可以直接通过这里进入容器内

![](https://gitee.com/sysker/picBed/raw/master/images/20210515133621.png)

![](https://gitee.com/sysker/picBed/raw/master/images/20210515134145.png)
...
![](https://gitee.com/sysker/picBed/raw/master/images/20210515141948.png)
