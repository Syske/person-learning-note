...
下面这张图片很好地展示了配置路由器和配置路由后的访问情况，配置路由前，我们访问`activemq-k8s`，提示无法解析主机，但当我们添加路由配置后，再次访问，发现这时候`activemq-k8s`已经可以正常解析了，而且返回了页面内容。![](https://syske-pic-bed.oss-cn-hangzhou.aliyuncs.com/imgs/images/20210630143827.png)
