...
- `mail.smtp.starttls.enable`：设置`TLS`是否启用，如果是`SSL`通信协议，该设置项必须未设置或者值为`flase`，否则也会报错：![](https://syske-pic-bed.oss-cn-hangzhou.aliyuncs.com/imgs/2022/20220404140850.png)
