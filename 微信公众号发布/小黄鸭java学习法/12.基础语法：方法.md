...
这里需要注意的是，在构造方法中通过`this`调用自己的构造方法时，调用操作必须写在第一行，否则会报编译错误：![](https://gitee.com/sysker/picBed/raw/master/20210227105447.png)
...
![](https://gitee.com/sysker/picBed/raw/master/20210227111412.png)